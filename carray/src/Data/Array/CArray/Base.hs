...
"freeze/IOCArray/Int8"   freeze      = freezeIOCArray :: (Ix i) => IOCArray i Int8 -> IO (CArray i Int8)
"freeze/IOCArray/Int16"  freeze      = freezeIOCArray :: (Ix i) => IOCArray i Int16 -> IO (CArray i Int16)
"freeze/IOCArray/Int32"  freeze      = freezeIOCArray :: (Ix i) => IOCArray i Int32 -> IO (CArray i Int32)
"freeze/IOCArray/Int64"  freeze      = freezeIOCArray :: (Ix i) => IOCArray i Int64 -> IO (CArray i Int64)
"freeze/IOCArray/Word"   freeze      = freezeIOCArray :: (Ix i) => IOCArray i Word -> IO (CArray i Word)
"freeze/IOCArray/Word8"  freeze      = freezeIOCArray :: (Ix i) => IOCArray i Word8 -> IO (CArray i Word8)
"freeze/IOCArray/Word16" freeze      = freezeIOCArray :: (Ix i) => IOCArray i Word16 -> IO (CArray i Word16)
"freeze/IOCArray/Word32" freeze      = freezeIOCArray :: (Ix i) => IOCArray i Word32 -> IO (CArray i Word32)
"freeze/IOCArray/Word64" freeze      = freezeIOCArray :: (Ix i) => IOCArray i Word64 -> IO (CArray i Word64)
...
"thaw/IOCArray/Int8"     thaw        = thawIOCArray   :: (Ix i) => CArray i Int8 -> IO (IOCArray i Int8)
"thaw/IOCArray/Int16"    thaw        = thawIOCArray   :: (Ix i) => CArray i Int16 -> IO (IOCArray i Int16)
"thaw/IOCArray/Int32"    thaw        = thawIOCArray   :: (Ix i) => CArray i Int32 -> IO (IOCArray i Int32)
"thaw/IOCArray/Int64"    thaw        = thawIOCArray   :: (Ix i) => CArray i Int64 -> IO (IOCArray i Int64)
"thaw/IOCArray/Word"     thaw        = thawIOCArray   :: (Ix i) => CArray i Word -> IO (IOCArray i Word)
"thaw/IOCArray/Word8"    thaw        = thawIOCArray   :: (Ix i) => CArray i Word8 -> IO (IOCArray i Word8)
"thaw/IOCArray/Word16"   thaw        = thawIOCArray   :: (Ix i) => CArray i Word16 -> IO (IOCArray i Word16)
"thaw/IOCArray/Word32"   thaw        = thawIOCArray   :: (Ix i) => CArray i Word32 -> IO (IOCArray i Word32)
"thaw/IOCArray/Word64"   thaw        = thawIOCArray   :: (Ix i) => CArray i Word64 -> IO (IOCArray i Word64)
